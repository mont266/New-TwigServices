        ...
        <div className="flex justify-between items-center h-20">
          ...
          {!isAdminView && (
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="#contact" onClick={onHomeClick} className="text-slate-600 dark:text-slate-300 hover:text-primary-500 dark:hover:text-primary-400 font-medium transition-colors">Contact</a>
              <button
          ...
          <div className="px-4 pt-2 pb-6 space-y-2">
            {!isAdminView ? (
              <>
                ...
                <a href="#contact" onClick={() => { onHomeClick(); setIsMenuOpen(false); }} className="block px-3 py-3 text-slate-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-slate-800 hover:text-primary-600 dark:hover:text-primary-400 rounded-lg font-medium">Contact</a>
                <div className="pt-4">
                  <button 
